...
public class TestcaseHRM {
	...
	//Row Count and verify
		...
		for(int i=1;i<=RC;i++)
		{
			String code=Driver.findElement(By.xpath("//table[@class='data-table']/tbody/tr["+i+"]/td[2]")).getText();
			String Name=Driver.findElement(By.xpath("//table[@class='data-table']/tbody/tr["+i+"]/td[3]/a")).getText();
			if(code.equals(EMPID) && Name.equals(SFN+" "+SLN))
			{
				System.out.println(code+" "+Name+" displayed at" +i );
				break;
			}
		}
